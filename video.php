		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12 naveg">
					<div class="container">
						<div class="col-md-6 <n></n>ame" style="text-align:center;"><h1>Samuel UC</h1><h4>Programador Web/ Integrador</h4></div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="embed-responsive embed-responsive-16by9">
					  <iframe class="embed-responsive-item" src="//www.youtube.com/embed/yKQRONJ9kQQ"></iframe>
					</div>
				</div>
			</div>
		</div>
